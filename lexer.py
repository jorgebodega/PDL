...
# Listas
reserved = ('true', 'false', 'var', 'function', 'int', 'bool', 'chars',
            'write', 'prompt', 'return', 'switch', 'case', 'break', 'if')
operators = ('*', '>', '!', '=', '++', '(', ')', '{', '}', ':', '-', ',', ';')
...
# Expresión regular que nos permite identificar cadenas de números,
# empiecen o no por un -
...
def t_NUM(t):
    ...
    if (int(t.value) <= 32767):
        ...
        archivo.write("Illegal number '%i': Out of Bounds\n" % int(t.value))
...
# Expresión regular que nos permite identificar cadenas de caracteres
# incluidas entre ' y '
...
# Si la expresión que encontramos no esta incluida como identificador, la
# añadimos
